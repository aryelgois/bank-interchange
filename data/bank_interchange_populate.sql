...
INSERT INTO `shipping_file_movements` (`id`, `bank`, `cnab`, `code`, `name`) VALUES
(1, 2, '240', '01', 'Entrada de Títulos'),
(2, 2, '240', '02', 'Pedido de Baixa'),
(3, 2, '240', '04', 'Concessão de Abatimento'),
(4, 2, '240', '05', 'Cancelamento de Abatimento'),
(5, 2, '240', '06', 'Alteração de Vencimento'),
(6, 2, '240', '07', 'Concessão de Desconto'),
(7, 2, '240', '08', 'Cancelamento de Desconto'),
(8, 2, '240', '12', 'Alteração de Juros de Mora'),
(9, 2, '240', '13', 'Dispensar Cobrança de Juros de Mora'),
(10, 2, '240', '14', 'Alteração de Valor/Percentual/Data de Multa'),
(11, 2, '240', '15', 'Dispensar Cobrança de Multa'),
(12, 2, '240', '16', 'Alteração de Valor/Data de Desconto'),
(13, 2, '240', '18', 'Alteração do Valor de Abatimento'),
(14, 2, '240', '19', 'Prazo Limite de Recebimento - Alterar'),
(15, 2, '240', '21', 'Alterar número do título dado pelo cedente'),
(16, 2, '240', '31', 'Alteração de Outros Dados'),
(17, 2, '240', '42', 'Alteração de Espécie de Título'),
(18, 3, '400', '01', 'Entrada Normal'),
(19, 3, '400', '02', 'Pedido de Baixa'),
(20, 3, '400', '04', 'Concessão de Abatimento'),
(21, 3, '400', '06', 'Alteração de Vencimento'),
(22, 3, '400', '07', 'Alteração do Uso da empresa (Número de Controle)'),
(23, 3, '400', '08', 'Alteração de Seu número'),
(24, 3, '400', '09', 'Protestar'),
(25, 3, '400', '10', 'Não Protestar'),
(26, 3, '400', '12', 'Inclusão de Ocorrência'),
(27, 3, '400', '13', 'Exclusão de Ocorrência'),
(28, 3, '400', '31', 'Alteração de Outros Dados'),
(29, 3, '400', '32', 'Pedido de Devolução'),
(30, 3, '400', '33', 'Pedido de Devolução (entregue ao Sacado)'),
(31, 3, '400', '99', 'Pedido dos Títulos em Aberto');
